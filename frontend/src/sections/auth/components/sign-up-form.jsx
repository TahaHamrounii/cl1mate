...
export function SignUpForm({ sx, ...other }) {
  ...
  return (
    ...
    >
      ...
      <Field.Text name="phone" label="Phone number" placeholder="+216..." slotProps={{ inputLabel: { shrink: true } }} />

      <Field.Select name="role" label="Role" slotProps={{ inputLabel: { shrink: true } }}>
        <MenuItem value="hotel">Hotel</MenuItem>
        <MenuItem value="pnud">PNUD Methanization</MenuItem>
